...
; Virtual methods: 0 / 0
; generated code sizes (bytes): 1308 (incl. 746 user, 534 helpers, 12 vtables, 16 lits); src size 0
; assembly: 917 lines; density: 248.67 bytes/stmt; (3 stmts)
; total bytes: 219420 (90.4% of 237.0k flash with 23268 free)
...
; start
    ...
    .hex 90260212AE4A43B3 ; hex template hash
    .hex 5908B8710261EAC5 ; program hash
    .short 4   ; num. globals
