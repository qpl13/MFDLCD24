...
//ILI9340 Frame Rate
    ...
    LCD_WriteReg(0xcb); //normal display on
    LCD_WriteReg(0x01);  // display inverse off
    ...
    LCD_WriteData_8Bit(0x82);
       
    LCD_WriteReg(0xc7);  
    LCD_WriteData_8Bit(0xb5);

    
    LCD_WriteReg(0xf2);  //power control
    LCD_WriteData_8Bit(0x00);
    ...
    LCD_WriteData_8Bit(0x55);
           ...
           LCD_WriteData_8Bit(0x1d);
           LCD_WriteData_8Bit(0x0f);
           
           LCD_WriteReg(0xE1);  //ne gamma correction
...
void LCD_Driver::LCD_SetPoint(UWORD Xpoint, UWORD Ypoint, UWORD Color)
{
    ...
    /* UWORD x, y,Xend,Xstart, Xend, Yend;
